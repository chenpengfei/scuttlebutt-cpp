...
TEST(filter, scuttlebutt_pull_utils) {
    sb::update update_1 = make_tuple(nlohmann::json(), 2, "A", "", "");
    sb::sources sources;
...
TEST(sort, scuttlebutt_pull_utils) {
    sb::update update_1 = make_tuple(nlohmann::json(), 1, "A", "", "");
    sb::update update_2 = make_tuple(nlohmann::json(), 2, "B", "", "");
    sb::update update_3 = make_tuple(nlohmann::json(), 3, "C", "", "");
    sb::update update_4 = make_tuple(nlohmann::json(), 2, "A", "", "");
    sb::update update_5 = make_tuple(nlohmann::json(), 2, "C", "", "");
