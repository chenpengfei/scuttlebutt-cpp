...
const model_accept not_accept{vector<string>{}, vector<string>{"ignored"}};
...
TEST(blacklist_filter_out_in_history, model_filter) {
    model a(scuttlebutt_options("A"));
    model b(scuttlebutt_options{"B", not_accept});
